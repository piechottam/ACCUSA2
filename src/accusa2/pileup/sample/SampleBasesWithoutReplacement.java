...
public class SampleBasesWithoutReplacement {
	...
	public Pileup[] sample(final Pileup pileup1, final Pileup pileup2) {
		...
		System.arraycopy(pileup1.getBASQs(), 0, basqs1, 0, basqs1.length);
		pileups[0].setBASQs(basqs1);
		System.arraycopy(pileup2.getBASQs(), 0, basqs2, 0, basqs2.length);
