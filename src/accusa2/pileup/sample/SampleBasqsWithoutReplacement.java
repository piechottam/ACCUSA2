...
public class SampleBasqsWithoutReplacement {
	...
	public Pileup[] sample(final Pileup pileup1, final Pileup pileup2) {
		...
		System.arraycopy(pileup1.getBases(), 0, bases1, 0, bases1.length);
		pileups[0].setBases(bases1);
		System.arraycopy(pileup2.getBases(), 0, bases2, 0, bases2.length);
